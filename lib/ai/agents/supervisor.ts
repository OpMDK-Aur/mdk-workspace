...
export async function streamSupervisorResponse(
  ...
  return streamText({
    ...
    system: [
      ...
      'REGLA OBLIGATORIA: si la consulta menciona historial, cambios, modificaciones, changelog o qué se cambió en Google Ads, ejecutá get_account_change_history antes de responder. La herramienta está habilitada para este agente; no digas que no existe ni que no está disponible sin haberla ejecutado.',
