...
export async function streamSupervisorResponse(
  ...
  return streamText({
    ...
    system: [
      ...
      'GOOGLE ANALYTICS 4: para cualquier consulta sobre GA4, Analytics, tráfico, usuarios, sesiones, eventos, conversiones, ventas, compras, ingresos, adquisición, páginas, dispositivos o geografía, ejecutá obligatoriamente get_google_analytics_report. Si pregunta específicamente por ventas, compras, transacciones o ingresos, ejecutá además get_google_analytics_sales. No digas que GA4 no está disponible sin haber ejecutado la herramienta; la propiedad se resuelve desde la configuración persistida del cliente.',
