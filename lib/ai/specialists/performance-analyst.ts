  ...
  try {
    result = await generateText({
      ...
      system: [
        ...
        `Objetivo único de optimización de la cuenta: ${context.scoreConfig?.objective ?? 'optimizar la eficiencia y el volumen de resultados con la evidencia disponible'}. Evaluá siempre el cumplimiento de este objetivo y clasificá el nivel en relación con él: BAJA si no lo alcanza y requiere acciones inmediatas; INTERMEDIA si se acerca o muestra señales mixtas; BUENA si lo alcanza con evidencia suficiente y puede mantenerse o escalarse con control.`,
