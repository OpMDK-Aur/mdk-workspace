...
DROP POLICY IF EXISTS "clients_insert_managers" ON clients;
DROP POLICY IF EXISTS "clients_update_managers" ON clients;
DROP POLICY IF EXISTS "clients_delete_direccion" ON clients;
DROP POLICY IF EXISTS "clients_select_managers_all" ON clients;
DROP POLICY IF EXISTS "user_client_access_insert_managers" ON user_client_access;
DROP POLICY IF EXISTS "user_client_access_update_managers" ON user_client_access;
DROP POLICY IF EXISTS "user_client_access_delete_managers" ON user_client_access;
DROP POLICY IF EXISTS "user_client_access_select_managers" ON user_client_access;
