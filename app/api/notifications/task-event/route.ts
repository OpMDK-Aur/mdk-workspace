...
export type TaskEventType = 'tarea_resuelta' | 'tarea_resolviendo' | 'asignado_a_tarea' | 'persona_agregada' | 'cliente_agregado'
  ...
  try {
    ...
    switch (eventType) {
      case 'tarea_resuelta':
        ...
        break
      case 'tarea_resolviendo':
        titulo = `Tarea en progreso: ${taskTitle}`
        descripcion = `Cambiada a "Resolviendo" por ${actorName}`
        break
