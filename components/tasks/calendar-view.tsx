  ...
  return (
    <div className="border-b">
      ...
      <div className="relative min-h-[24px]">
        ...
        <div className="relative flex flex-col gap-1 px-1.5 pt-1.5 pb-6">
          ...
          return (
            <Popover key={dayKey}>
              <PopoverTrigger asChild>
                <button
                  className="absolute bottom-1 py-1 text-[11px] font-medium text-primary transition-colors hover:bg-primary/10 hover:text-primary/80 rounded"
