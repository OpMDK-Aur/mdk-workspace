...
export function ServiceMapMilestoneEditor() {
  ...
  const planHitos = items.filter((item) => !selectedClient?.plan || item.tipo_servicio === selectedClient.plan)
